...
function botonPresionado(boton, x, y) {
    ...
    if (estado == 0) {
        ...
        crearTablero();
        document.getElementById("cara").src = "../assets/games/Buscaminas/images/smile.png";
        resetTime();
    }
...
function gameOver() {
    estado = 1;
    document.getElementById("cara").src = "../assets/games/Buscaminas/images/smileB.png";
}

//Cambio del estado de la partida a Victoria
function victoria() {
    estado = 2;
    document.getElementById("cara").src = "../assets/games/Buscaminas/images/smileH.png";
}
